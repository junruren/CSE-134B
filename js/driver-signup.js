...
function addYears() {
  for (var i = 0; i < years.length; i++) {
    ...
    newOption.text = years[i];
    document.getElementById('vehicle-year').appendChild(newOption);
  }
}
...
function addColors() {
  for (var i = 0; i < colors.length; i++) {
    ...
    document.getElementById('vehicle-color').appendChild(newOption);
  }
}

function addMaxPassengers() {
  for (var i = 1; i < 8; i++) {
    var newOption = document.createElement('option');
    newOption.value = i;
    newOption.text = i;
    ...
    document.getElementById('max-passengers').appendChild(newOption);
  }
}

function addMakes() {
  for (var make in vehicles) {
    var newMakeOption = document.createElement('option');
    newMakeOption.value = make;
    newMakeOption.text = make;
    document.getElementById('vehicle-make').appendChild(newMakeOption);
  }
}
...
function fillInModels(make) {
  for (var i = 0; i < vehicles[make].length; i++) {
    var newModelOption = document.createElement('option');
    newModelOption.value = vehicles[make][i];
    newModelOption.text = vehicles[make][i];
    document.getElementById('vehicle-model').appendChild(newModelOption);
  }
}

function addModels() {
  document.getElementById('vehicle-make').onchange = function () {
    removeAllModels();
    var selectedIndex = document.getElementById('vehicle-make').selectedIndex;
    var selectedMake = document.getElementById('vehicle-make').options[selectedIndex].value;
    fillInModels(selectedMake);
  };
}
...
function addAirports() {
  for (var i = 0; i < airports.length; i++) {
    var newOption = document.createElement('option');
    newOption.value = airports[i];
    newOption.text = airports[i];
    document.getElementById('airport').appendChild(newOption);
  }
}
