            ...
            <div className="vertical-middle">
              ...
              <div className="choose-rides-for-d-a">
                <label className="checkbox-container">A ride for your departure (e.g. from your home to an airport)
                  <input className="input" type="checkbox" id="checkbox-departure"/>
                  <span className="checkmark"></span>
                </label>
                <hr/>
                <label className="checkbox-container">A ride after your arrival (e.g. from an airport to your destination)
                  <input className="input" type="checkbox" id="checkbox-arrival"/>
                  <span className="checkmark"></span>
                </label>
              </div>
            ...
            <div className="vertical-middle">
              ...
              <div className="details flex-container">
                <div className="flight-details">
                  ...
                  <label className="checkbox-container">Allow paired driver to know my flight no.
                ...
                <div className="location-details">
                  <div className="pick-up">
                    ...
                    <input className="input" id="input-origin" type="text" placeholder="Arrival Gate B, Tom Bradly Intl Terminal" />
                  </div>
                  <div className="drop-off">
                    <p>Ride destination</p>
                    <input className="input" id="input-destination" type="text" placeholder="9229 Regents Road, La Jolla, CA 92037" />
                  </div>
                </div>
              </div>
              <div className="footer">
            ...
            <h1 style={styles.h1_over_dark_bg}>A ride for your arrival</h1>
              ...
              <div className="details flex-container">
                <div className="flight-details">
                  ...
                  <p id="date">{this.state.rider_trip_demo['arrival']['flight_info']['date']}</p>
                  <label className="checkbox-container">Allow paired driver to know my flight no.
                    <input className="input" id="check-share-allowed" type="checkbox" checked disabled />
                    <span className="checkmark"></span>
                  </label>
                </div>
                <div className="party-details">
                  <p>Including you</p>
                  <p>How many persons will be riding?</p>
                  <input className="input" id="input-num" type="number" name="persons" value={this.state.rider_trip_demo['arrival']['passenger_info']['total_riders']} disabled />
                  <label className="checkbox-container">Currently don't know *
                    <input className="input" id="check-unknown" type="checkbox" disabled />
                    <span className="checkmark"></span>
                  </label>
                </div>
                <div className="location-details">
                  <div className="pick-up">
                    <p>Meet your driver at</p>
                    <input className="input" id="input-origin" type="text" placeholder="Arrival Gate B, Tom Bradly Intl Terminal" disabled />
                  </div>
                  <div className="drop-off">
                    <p>Ride destination</p>
                    <input className="input" id="input-destination" type="text" placeholder="9229 Regents Road, La Jolla, CA 92037" disabled />
                  </div>
                </div>
              </div>
              <div className="footer">
